...
namespace FootballAcademy_BackEnd.Migrations
{
    ...
    [Migration("20240318122049_added_training_group_relationship")]
    partial class added_training_group_relationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FootballAcademy_BackEnd.Entities.Club", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FootballAcademy_BackEnd.Entities.Fee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FootballAcademy_BackEnd.Entities.PlayerHasTrainingGroup", b =>
                {
                    b.Property<Guid>("PlayerId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("PlayerId", "TrainingGroupId");

                    b.HasIndex("TrainingGroupId");

                    b.ToTable("PlayerHasTrainingGroup", (string)null);
                });
            ...
            modelBuilder.Entity("FootballAcademy_BackEnd.Entities.TrainingGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FootballAcademy_BackEnd.Entities.TrainingGroupHasCoach", b =>
                {
                    ...
                    b.HasKey("CoachId", "TrainingGroupId");

                    b.HasIndex("TrainingGroupId");

                    b.ToTable("TrainingGroupHasCoach", (string)null);
                });
            ...
            modelBuilder.Entity("FootballAcademy_BackEnd.Entities.PlayerHasTrainingGroup", b =>
                {
                    ...
                    b.HasOne("FootballAcademy_BackEnd.Entities.TrainingGroup", "TrainingGroup")
                        .WithMany()
            ...
            modelBuilder.Entity("FootballAcademy_BackEnd.Entities.TrainingGroupHasCoach", b =>
                {
                    b.HasOne("FootballAcademy_BackEnd.Entities.User", "Coach")
                        .WithMany()
